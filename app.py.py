...
#os._exit(0)
 ...
 x_cluster.set_title('KMeans Clusters of Income and Expenses')#                     legend1 = ax_cluster.legend(*scatter.legend_elements(), title="Clusters")
     ...
     if st.session_state.logged_in:
         ...
         st.info("""
         Financial literacy enables individuals to make informed financial decisions, avoid debt traps, and plan for their future.
         In Kenya, SACCOs have become pivotal in improving access to financial services, and understanding their structure#         and offerings is vital for inclusive growth.
         """)
